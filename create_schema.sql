/*
DROP TABLE IF EXISTS INDIVIDUAL_LESSON_FILE;
...
(
    ...
    GROUP_ID   VARCHAR(36) NOT NULL REFERENCES STUDENTS_GROUP (ID),
...
(
    ...
    START_DATE_OF_LESSON   TIMESTAMPTZ                                  NOT NULL,
    END_DATE_OF_LESSON     TIMESTAMPTZ                                  NOT NULL,
    DESCRIPTION            VARCHAR(2000),
    ORGANIZATION_ID        VARCHAR(50) REFERENCES ORGANIZATION (EMAIL_ADDRESS),
    TUTOR_ID               VARCHAR(50) REFERENCES TUTOR (EMAIL_ADDRESS) NOT NULL,
    GROUP_ID               VARCHAR(50) REFERENCES STUDENTS_GROUP (ID)   NOT NULL,
    CREATION_DATE_TIME     TIMESTAMPTZ                                  NOT NULL,
...
CREATE TABLE INDIVIDUAL_LESSON_FILE
(
    LESSON_ID VARCHAR(36) NOT NULL REFERENCES INDIVIDUAL_LESSON (LESSON_ID),
    FILE_ID   VARCHAR(36) NOT NULL REFERENCES LESSON_FILE (FILE_ID),
